...
fileprivate struct EventDataSource {
    fileprivate func dummyEvents () -> [EventEntity] {
            ...
            return [EventEntity(organiser: "Adolfo & Tania", name: "Partnerwork", startDate: dummyTomorrow , endDate: dummyDayAfterTomorrow, location: "London", type: EventTypes.salsa, image: UIImage(named: "party")),
